...
# Fixed implication multipliers.
# They must be fixed constants to keep the SOS program convex.
#
# If the model is infeasible with 1.0, try:
#
#     0.1, 0.01, 0.001
#
# for all three constants, or asymmetric values such as:
#
#     IMP_MULT_P2   = 0.01
#     IMP_MULT_P3_A = 0.001
#     IMP_MULT_P3_B = 0.001
...
const IMP_MULT_P3_A = 0.001
const IMP_MULT_P3_B = 0.001

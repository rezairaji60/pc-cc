...
const OUT_JLD2 = joinpath(RESULTS_DIR, "pccc_synth_platoon_tssos.jld2")
const OUT_JSON = joinpath(RESULTS_DIR, "pccc_synth_platoon_tssos.json")
const OUT_STATUS_JSON = joinpath(RESULTS_DIR, "pccc_synth_platoon_tssos_status.json")
...
println("TSSOS sparsity settings: CS=", TSSOS_CS, ", TS=", TSSOS_TS, ", SO=", TSSOS_SO)
...
function save_status_only(model, num_psatz_constraints)
    ...
    json_dict = Dict(
        ...
        "certificate_type" => "tssos_implication_pairwise_fixed_scalar",

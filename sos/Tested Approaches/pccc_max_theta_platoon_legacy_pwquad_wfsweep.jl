...
function main()
    ...
    println("Legacy pwquad max-theta WF/rho sweep")
    println("Forward grid: coarse 15x15; WF/X0 grids varied; original lambdas lambda2=lambda3=0.02")
    ...
    out = joinpath("results", "diagnostics", "legacy_pwquad_max_theta_wfsweep.json")
    open(out, "w") do io
